...
import { invoicesService, Invoice, UpdateInvoiceRequest } from '@/api/services/invoices.service';
...
const EditInvoiceDialog: React.FC<EditInvoiceDialogProps> = ({
  ...
  const calculateTotals = () => {
    ...
    const tax = afterDiscount * 0.16; // 16% tax
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedInvoice = await invoicesService.updateInvoice(invoice.id, requestData);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="p-2 bg-muted rounded-md">
                ...
                <p className="text-sm text-muted-foreground">{invoice.customer.contactPerson}</p>
              </div>
            </div>
