...
import { Loader2, RefreshCw, ArrowLeft, Car, Calendar, FileText, Receipt, Wallet } from "lucide-react";
import { formatCurrency, formatDate } from "@/utils/format.utils";

const CustomerDetail = () => {
  const { customerId } = useParams<{ customerId: string }>();
  const { data, loading, refreshing, error, refresh } = useCustomerDetail(customerId || "");
  ...
  const name = customer?.businessName || customer?.contactPerson || customer?.customerCode || "Customer";
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Comprehensive customer view: vehicles, subscriptions, invoices, payments, transactions
            </p>
          </div>
        </div>
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="border-l-4 border-l-primary">
              ...
              <CardContent>
                <div className="text-2xl font-bold">{formatCurrency(Number(data.financials.currentBalance))}</div>
            ...
            <Card className="border-l-4 border-l-green-500">
              ...
              <CardContent>
                <div className="text-2xl font-bold">{formatCurrency(Number(data.financials.totalInvoiced))}</div>
                <div className="text-xs text-muted-foreground mt-1">
            ...
            <Card className="border-l-4 border-l-yellow-500">
              ...
              <CardContent>
                <div className="text-2xl font-bold">{formatCurrency(Number(data.financials.totalOutstanding))}</div>
                <div className="text-xs text-muted-foreground mt-1">
